...
export function PortfolioTracker({ onBackToHome, userProfile, onEditProfile }) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      >
        ...
        >
          ...
          <div className="border-t border-slate-800 mt-12 pt-8 text-right text-gray-400 animate-fade-in-up animation-delay-500">
            <p>&copy; 2025 SupplyChain Management Tracker. All rights reserved.</p>
          </div>
          <p className="mt-1">
